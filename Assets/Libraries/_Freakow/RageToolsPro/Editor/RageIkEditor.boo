...
public class RageIkEditor (RageToolsEdit):
	...
	public def OnDrawInspectorHeaderLine():
		...
		EasyToggle "CCW Bias", _rageIk.CcwBias, MaxWidth(80f)
	...
	public def OnDrawInspectorGUI():
		...
		EasySettings:
			EasyRow:
				EasyToggle "Joint Gizmos", _rageIk.DebugRay
				LookLikeControls(40f, 23f)
				EasyFloatField "Snap", _rageIk.Chain.Snap
			return if not _rageIk.DebugRay
			EasyRow:
				LookLikeControls(80f, 30f)
				EasyFloatField "Joint Size", _rageIk.JointSize, MaxWidth(110f)
				LookLikeControls(80f, 20f)
				_rageIk.JointColor = EditorGUILayout.ColorField("Color",_rageIk.JointColor)
