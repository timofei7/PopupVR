...
-- Current Version: 1.6.4 (changelog at www.ragespline.com)
...
Double-click = Add new control point to selected RageSpline
...
* For learn about all that RageSpline can do for you, please download the updated online documentation: 
http://www.freakow.com/ragetools/ragespline_docs_raw_html.zip

* Homepage:
www.ragespline.com
Company Homepage: www.freakow.com
Also check our RageTools and RageTools Pro extensions for RageSpline!
...
NOTE: In the Physics Game template, change gravity from the project settings to something like -100 if you want a more realistic feel.
